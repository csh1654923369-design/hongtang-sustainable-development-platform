...
async function __wbg_init(module_or_path) {
	...
	if (module_or_path === void 0) module_or_path = new URL("/geolibre/assets/geolibre_wasm_bg-DgniorZ9.wasm", "" + import.meta.url);
...
async function initTools(source) {
	...
	if (!source) source = new URL("/geolibre/assets/geolibre-cli-Ca2b2kwV.wasm", "" + import.meta.url);
