...
import { ArrowUpRight, CalendarDays, ClipboardPenLine, History, Map, MapPinPlus, Sparkles, UploadCloud } from "lucide-react";
import { useRouter } from "next/navigation";
import { useDemo } from "@/components/providers/DemoProvider";
import { Permission, can } from "@/lib/permissions";

const icons = { report: MapPinPlus, map: Map, action: Sparkles, project: ClipboardPenLine, activity: CalendarDays, research: UploadCloud, change: History };
