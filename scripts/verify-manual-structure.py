...
assert any(paragraph.text.startswith("版本：V1.75") for paragraph in document.paragraphs)
...
assert [len(table.rows) for table in document.tables] == [6, 6, 7, 9, 14, 38]
...
assert document.tables[5].rows[1].cells[0].text == "V1.75"
